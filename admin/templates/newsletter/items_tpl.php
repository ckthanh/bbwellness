...
<table cellpadding="0" cellspacing="0" width="100%" class="sTable withCheck mTable" id="checkAll">
	...
	<tr style="text-align:center">
        ...
        <td>STT</td>
         <td class="sortCol"><div>Tên<span></span></div></td>
          <td class="sortCol"><div>Số điện thoại<span></span></div></td>
        <td class="sortCol"><div>Email<span></span></div></td>
         <td class="sortCol"><div>Thắc mắc<span></span></div></td>
	...
	<tr style="text-align:center">
        ...
        <td  style="width:30%;" align="center"><b><?=$items[$i]['ten']?></b></td>
        <td  style="width:10%;" align="center"><b><?=$items[$i]['sdt']?></b></td>
        <td  style="width:20%;" align="center"><b><?=$items[$i]['email']?></b></td>
        <td  style="width:30%;" align="center"><b><?=$items[$i]['thacmac']?></b></td>
